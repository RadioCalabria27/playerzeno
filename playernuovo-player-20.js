...
(function ($) {
  $.fn.repro19 = function (options) {
    var settings = $.extend({
      ...
      artwork: true,
      logo: "https://img.xatblog.net/image/oa6TV74MO4k.png",
      servertitle: "RadiVivaForever",
      show_listeners: true,
      src: "",
      volume: 0.75,
      autoplay: true
    ...
    function FBShare(result) {
      ...
      function INSShare(result) {
      var siteURL = window.location.href;
      var url = "https://www.instagram.com/";
      $("#ains", thisObj).attr("href", url)
    }
